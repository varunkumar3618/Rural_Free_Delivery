...
def convert_state(state):
	...
	filename = "Files/" + state.lower() +".rtf"
	...
	for line in plaintext:
		...
		if m:
			ind = m.start()
			Towns.append({"Name" : line[0:ind+1], "Date" : line[ind+1:]})
		else:
			print "Not found " + line

	#Add Chattanooga in Tennessee and Washington Court House in Ohio
	#The parser misreads these lines because of punctuation
	if state == "Tennessee":
		Towns.append({"Name" : "Chattanooga", "Date" : "05/15/1901"})
		print "Added to Tennessee"
	elif state == "Ohio":
		Towns.append({"Name" : "Washington Court House", "Date" : "09/01/1902"})
		print "Added to Ohio"
